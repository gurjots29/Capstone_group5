...
class User(AbstractUser):
    profile_image = models.ImageField("profile_image", upload_to="users_profile/", blank=True)
    background_image = models.ImageField("background_image", upload_to="users_profile/", blank=True, null=True)
    headline = models.TextField(max_length=80, blank=True)
    # like_posts = models.ManyToManyField(
    #     "posts.Post",
    #     verbose_name="Like posts list",
...
class Volunteer(models.Model):
    ...
    location = models.CharField(max_length=255, blank=True,
                                null=True)  # Consider using a more detailed location model or a library like django-cities for more granularity
